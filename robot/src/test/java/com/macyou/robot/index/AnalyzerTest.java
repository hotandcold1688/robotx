...
public class AnalyzerTest {
	...
	private static String[] texts = {
			"IkAnalyzer是一个开源的，基于java语言开发的轻量级的中文分词工具包。从2006年12月推出1.0版开始， IKAnalyzer已经推出了4个大版本。",//<BR>
			"你好同学" };
	...
	public void test() throws IOException {
		...
		Analyzer analyzer = new StandardAnalyzer(Constants.LUCENE_VERSION, new FileReader("target/classes/stopword.dic"));
